...
#### Положительный синхронный <a name="responses.positive_synchronous"></a>
...
#### Положительный асинхронный <a name="responses.positive_asynchronous"></a>
...
* `200 (OK)`  - запрос принят и обработан (напр.: пользователь зарегистрирован);
